...
class ImageIDs(BaseSettings):
    ...
    MAIN_MENU: str = 'BQACAgIAAxkBAAID_mkAAWPV-KgwRQtgkGSJqhcMy7W5MQACpY8AApBP-EsbxD6Gp0ogsTYE'
    TUTORIAL: str = 'AgACAgIAAxkBAAP2aOpA6mg7urCWDFBfAAHnR-3FxdmdAAKqCzIbY6VZS-wxpVnyqYfdAQADAgADeAADNgQ'
    FAVORITES_ADS: str = 'BQACAgIAAxkBAAIEBWkAAWPVyuyD-yxLYBkTVtcFGi38aQACrI8AApBP-EsBMY6TUU0rKTYE'
    ADD_AD: str = 'BQACAgIAAxkBAAIEAmkAAWPVB-KthfZU535Qj6l6PcZi1QACqY8AApBP-EtUBXOQNpxQ7zYE'
    ADMIN_PANEL: str = 'BQACAgIAAxkBAAIEA2kAAWPVLZeRFCdKcrZkwmwi3q9yjQACqo8AApBP-EujvjuAi8gYyzYE'
    CHANGE_LANG: str = 'BQACAgIAAxkBAAIEBGkAAWPVh_pQtQHnBBPrjmtzbwQu1wACq48AApBP-EtBk55FMpgEpzYE'
    SETTINGS_SEARCH: str = 'BQACAgIAAxkBAAIEAWkAAWPVscv8O9HBWyG-28esx65xewACqI8AApBP-EuqMCxjvt2SRDYE'
    MY_ADS: str = 'BQACAgIAAxkBAAID_2kAAWPVolK5p72NEQ0EjqFqhQlldAACpo8AApBP-Etlax6ClBFLaTYE'
    SEARCH: str = 'BQACAgIAAxkBAAIEAAFpAAFj1cRiVQXjiIUY96_zgfEZtf0AAqePAAKQT_hLloZ3oIkwBGc2BA'
